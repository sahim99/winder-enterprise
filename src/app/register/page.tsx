      ...
      <Card className="w-full max-w-sm border border-border/60 shadow-lg">
        ...
        <CardContent>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-11 rounded-full font-medium flex items-center justify-center gap-2 border-border/80 hover:bg-muted/50 transition-all cursor-pointer"
