...
export function LandingPage({ trending = [], livingRoom = [] }: LandingPageProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative w-full h-[90vh] min-h-[600px] overflow-hidden bg-gray-950 flex flex-col justify-end lg:justify-center">
          ...
          <div className="max-w-xl text-white space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-4 animate-fade-in-up delay-400">
              ...
              <Link href="/login" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="rounded-full px-10 font-bold border-white/20 text-white hover:bg-white/10 hover:text-white h-14 w-full hover:-translate-y-1 transition-all text-base backdrop-blur-md">
                  Sign In
                </Button>
              </Link>
            </div>
